...
writing_words = ['writer', 'writing', 'written', 'dialog', 'structure']
acting_words = ['character', 'performance', 'actor', 'acting']
directing_words = ['director', 'directing', 'direction']

#other potential categories:
story_words = ['story', 'plot', 'arc', 'narrative']
big_picture_words = ['plot', 'arc', 'concept', 'idea', 'epic', 'grand']
#words to indicate dislike of big picture: convoluted, confusing, complex
#words to indicate like of big picture: inventive, ambitious, bold, innovative, epic
structural_words = ['consistent', 'consistency', 'structure']
